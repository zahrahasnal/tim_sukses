    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="<?php echo e(asset ('img/logo.jpg')); ?>" alt="DISKOMINFO KOTA SEMARANG" class="brand-image img-circle elevation-3" style="opacity: .8">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-6">
                                    <ol class="breadcrumb float-sm-right">
                                        ...
                                        <li class="breadcrumb-item"><a href="#">Bidang Integrasi Sistem</a></li>
                        ...
                        <div class="card card-info card-outline">
                            <div class="card-header">
                                <div class="card-tools">
                                    ...
                                    <a href="<?php echo e(route('download.category', ['category' => 'Bidang Integrasi Sistem'])); ?>" class="btn btn-success">Download <i class="fas fa-download"></i></a>
                                </div>
                            </div>
...
</html><?php /**PATH D:\Projek\bismillah jadi\web_monitoring\resources\views/admin/index-integrasiSistem.blade.php ENDPATH**/ ?>