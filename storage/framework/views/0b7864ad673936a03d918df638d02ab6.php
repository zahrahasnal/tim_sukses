                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-6">
                                    <ol class="breadcrumb float-sm-right">
                                        ...
                                        <li class="breadcrumb-item"><a href="#">Bidang Infrastruktur</a></li>
                    ...
                    <div class="content">
                        <div class="card card-info card-outline">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <form action="<?php echo e(route('search-website')); ?>" method="GET">
                                                <input type="text" name="search" placeholder="Cari di seluruh kolom">
...
</html><?php /**PATH D:\Projek\bismillah jadi\web_monitoring\resources\views/admin/index-infrastruktur.blade.php ENDPATH**/ ?>