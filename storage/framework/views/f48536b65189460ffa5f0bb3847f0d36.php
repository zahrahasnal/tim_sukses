  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="card card-info card-outline">
        <div class="card-body">
          <form action="<?php echo e(route('save-users')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group">
                ...
                <select name="jenis_kel" class="form-control">
                    <option value="Laki-laki" <?php echo e(old('jenis_kel') === 'Laki-laki' ? 'selected' : ''); ?>>Laki-laki</option>
                    <option value="Perempuan" <?php echo e(old('jenis_kel') === 'Perempuan' ? 'selected' : ''); ?>>Perempuan</option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="alamat" class="form-control" value="<?php echo e(old('alamat')); ?>"></textarea>
            </div>
            ...
            <div class="form-group">
                <label for="posisi">Posisi</label>
                    <select name="posisi" class="form-control">
                        <option value="Magang" <?php echo e(old('posisi') === 'Magang' ? 'selected' : ''); ?>>Magang</option>
                        <option value="Karyawan" <?php echo e(old('posisi') === 'Karyawan' ? 'selected' : ''); ?>>Karyawan</option>
                    </select>
            </div>

            <div class="form-group">
                <label for="alamat">Password</label>
                <input type="password" name="password" class="form-control" value="<?php echo e(old('password')); ?>"></input>
            </div>
...
<?php /**PATH D:\Projek\bismillah jadi\web_monitoring\resources\views/admin/create-users.blade.php ENDPATH**/ ?>