        ...
        <div class="card-body">
          <form action="{{ route('save-users') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea name="alamat" class="form-control" placeholder="Masukkan Alamat" value="{{ old('alamat') }}"></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="password" name="password" class="form-control" placeholder="Masukkan Password" value="{{ old('password') }}"></input>
            </div>
