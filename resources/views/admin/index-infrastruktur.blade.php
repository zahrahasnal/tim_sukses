                                ...
                                <table class="table table-boardered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('delete-website', $website->id) }}" class="edit-icon" onclick="return confirm('Anda yakin ingin menghapus data ini?')"><i class="fas fa-trash text-danger"></i></a>
                                        </td>
